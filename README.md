...
Requirements:
-------------
You'll need to be running [StepMania 5.0.12](https://github.com/stepmania/stepmania/releases/tag/v5.0.12) or [StepMania 5.2](http://smnightly.katzepower.com/) to use this theme.  Older versions of StepMania are not compatible.
